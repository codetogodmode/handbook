...
- Typy, proměnné, podmínky, cykly
- Metody, kolekce, stringy
- Git: commit, branch, PR, merge
- Debugging: breakpointy, watch, stack trace
- **Výstup:** Funkční konzolová appka, merged PRs
- **AI režim:** EXPLAIN

## Layer 2 — OOP & Quality (týdny 4-6)
...
- **Výstup:** Domain model s testy
- **AI režim:** EXPLAIN → drilling na HELPER

## Layer 3 — Data & API (týdny 7-9)
...
- React + Vite + TypeScript + Tailwind (nebo Blazor)
...
- PostgreSQL (přechod ze SQLite)
- CI/CD: GitHub Actions → deploy
- Deployment na Fly.io
- **Výstup:** Appka na vlastní URL
- **AI režim:** BUILDER → drilling na GOD MODE

## Dedikované AI sessions

Probíhají průběžně, ne na konci:

- ~Týden 2: Jak se správně ptát AI
- ~Týden 6: Jak reviewovat AI kód
- ~Týden 10: AI-assisted architektura
- ~Týden 15-16: Full vibe coding workflow
